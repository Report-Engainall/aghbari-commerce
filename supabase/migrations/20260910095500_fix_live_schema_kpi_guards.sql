-- Reconcile KPI predicates with the live company schema: customers do not carry is_active.
...
declare v_company uuid:=public.current_company_id(); v_receivables numeric:=0;
begin
  if v_company is null then return query select 0::bigint,0::bigint,0::bigint,0::bigint,0::bigint,0::bigint,0::bigint,0::numeric,0::bigint,0::bigint,0::numeric,0::numeric; return; end if;
