...
select is((select count(*) from public.store_banners where organization_id=public.current_organization_id() and title='CMS Banner Updated'),1::bigint,'F20 inactive banner remains persisted');
