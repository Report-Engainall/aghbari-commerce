...
select throws_ok($$select * from public.transfer_inventory('56565656-5656-4565-8565-565656565671','56565656-5656-4565-8565-565656565672','short-stock-check-01',jsonb_build_array(jsonb_build_object('product_id','56565656-5656-4565-8565-565656565681','quantity',99)))$$,'22003','insufficient inventory for transfer','insufficient stock rejected');
select throws_ok($$select * from public.transfer_inventory('56565656-5656-4565-8565-565656565671','56565656-5656-4565-8565-565656565672','bad-quantity-check-01',jsonb_build_array(jsonb_build_object('product_id','56565656-5656-4565-8565-565656565681','quantity',0)))$$,'22023','invalid transfer quantity','zero quantity rejected');
