...
-- Exact trigger definitions. pg_get_triggerdef is authoritative and already executable.
...
-- Table grants. information_schema presents effective explicit grants in normalized form.
...
-- Sequence grants, when exposed by information_schema.
...
select format('GRANT EXECUTE ON FUNCTION public.%I(%s) TO %I;',
  routine_name, specific_name, grantee)
